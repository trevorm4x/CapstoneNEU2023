...
'''
lower_color = np.array([135, 80, 50])
...
if __name__ == '__main__':
    ...
    d_max = 50  # largest distance adjustment speed
    x_min = 10  # smallest sideways adjustment speed
    x_max = 40  # largest sideways adjustment speed
    yaw_min = 10
    yaw_max = 20
    y_min = 10  # smallest height adjustment speed
    y_max = 40  # largest height adjustment speed
    distance_t = 20000  # optimal distance value
    distance_r = 1000  # acceptable range
